...
const TUTORIAL_STEPS = [
  ...
  { target: 'member-auction-link', title: 'Auction', body: "Bid on items using OC you've earned." },
  ...
  { target: 'member-oc-submission-link', title: 'OC Submission', body: 'Submit downtime actions and requests to earn OC between events.' },
