delete from lore_entries where slug in ('welcome', 'how-to-use', 'history-of-ariel', 'war-of-the-twins', 'ruins-of-the-lakes-region');

insert into lore_entries (slug, title, category, body) values
('adders-point', 'Adder’s Point', 'Towns & Settlements', $body1$“Although the adder itself is not native to any part of Harodom, the barony of Adder’s Point is named instead for the Old Haro word for snakes and serpents, which admittedly, the barony has in abundance. The baronial lineage of Adder’s Point, the house of Hayden, has long been thought to be more good-natured than the name implies, but few survive in positions of power without a little venom to their bite.”
...
City Total Population: About 8600 permanent residents, 76% of whom are [[Humans|human]], 8% dwarves, 6% [[Elves]], and 10% representative of the other sapient [[Peoples of the Lakes Region]].
...
If you wish to start out with a pre-built character, or to find more information about the mechanics of starting out as an adventurer, you can find it [here](https://fantasyalivelrp.com/new-player-information/).

## Choosing a Species

The world of Fantasy Alive is peopled by a great many types of species. While it is encouraged that you try being [[Humans]] for your first event (since it is fairly likely that you are human yourself, and have a general idea of what humans are like), this is a guideline not a rule. In the area in which the games for Fantasy Alive are set, humans are the predominant species, but these areas are growing increasingly metropolitan, and adventurers are by their very nature unusual.
...
Your character may have been a soldier, a mercenary, or a student of martial prowess, and studied weapon skills. Perhaps they have sought schooling as a wizard, or taken holy orders as a priest, or generally received an education in one of the [[Magic in the World of Fantasy Alive|forms of magic]] that are studied in the world of Ariel. Certainly, many new adventurers have previously plied [[Trades and Vocations|some trade or another]], seeking to earn a living. All of these skills can be useful in the course of play and between games, and you can use your starting build to reflect what your character has studied prior to their entry into the world of swords and sorcery!
...
You can find the current rules of play, which describe the various skills, how they work, and what paths may lay before you [here](https://fantasyalivelrp.com/fantasy-alive-rulebook/). Depending on the skills that you choose, you may begin with pieces of equipment that reflect the gear that you have accumulated prior to your entry to play – learn more about this [here](https://endlessadventures.ca/pages/new-character-form?_pos=3&_sid=02ad0d589&_ss=r)!
...
Fantasy Alive is a series of unfolding stories that include your character – and as everyone knows, characters have to come from somewhere! Consider the following, and then follow [this link to our character history submission portal](https://endlessadventures.ca/pages/character-backstories?_pos=1&_sid=649d6c6eb&_ss=r)!
...
If you have questions or concerns, you can reach out to new.player.reps@fantasyalivelrp.com, [join our Discord](https://discord.gg/3qGzDygd3V), or reach out on our [Facebook page](https://www.facebook.com/groups/fantasyalivelarp). The world of Fantasy Alive is waiting for your story, so come and tell it!

## Next Steps

- [Check Out Our Rulebook](https://fantasyalivelrp.com/wp-content/uploads/2024/03/Fantasy-Alive-Manual-v13.1.1.pdf)

- [Join the FA Database](https://database.fantasyalivelrp.com/)

- [Explore Our Game Wiki!](https://fantasyalivelrp.com/wiki/)

Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body14$),
('buying-and-selling-items', 'Buying and Selling Items', 'Crafting & Trade', $body15$Look, there will be those who will tell you that power is expressed at the end of a sword, and others who will tell you that power is found in ancient tomes and magic rings. There’s one reliable source of power in the world that most of us live in, and it’s shiny and spends.

- Adeline of House Toth, Thoughts on the Continental Trade Agreement (1914 A.T.)

Ensuring that you have the right equipment to succeed in your adventures can be challenging. In terms of coin, adventure tends to cost money more than it makes money. What treasure can be recovered often takes the form of equipment, or less immediately fungible [[Treasure and Valuables|treasure]], like jewels, rings, or elaborate vases and tapestries.
...
Without the Merchant skill, most people can buy and sell only a few common items, and those at bad rates. Non-merchants can sell two common items and one uncommonitem per transaction, and will only receive 25% of the appraised value. They can buy two commonitems, but will pay 150% of the listed price for such items.

## Selling With the Merchant Skill

People learning to be Merchants can buy and sell goods – but even they have to specialize. Merchants can learn the ins and outs of transacting specific Categoriesof goods, finding superior prices and larger markets for those categories that make up their specialties. In general, Merchants will find it easier to buy rarer items than to sell them, but true masters of the bargain can still sell a number of valuable and rare items in their time.

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2026/05/image-1.png)

As this chart (found in the [Manual](https://fantasyalivelrp.com/wp-content/uploads/2024/03/Fantasy-Alive-Manual-v13.1.1.pdf), page 43) details, skilled merchants increase the number of categories or Item Groups that they can transact in, and how many items in those categories they can buy and sell.
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2026/05/image-2.png)
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body15$),
('callis', 'Callis', 'Deities', $body16$The Sun Servants The Followers of Callis
...
Although there is an understandable stereotype of celestials and infernals taking the form of winged guardians or horned fiends, the truth is a little more complicated. The main connection between the two groups is that – like [[Fae]], they originate from another plane of existence, overlaid with, but seldom directly interacting with that of the world of Ariel. Almost all celestials act as direct servitors to a [[The Pantheon]], but while many infernals align themselves with gods – and, as magically powerful as they are, come to take on associated physical characteristics – their relationship is more complex.
...
While this trend is not without its origins in fact, infernals and celestials may also call upon different energies, especially ones aligned with elemental gods. Servitors of Callis – celestial orinfernal – are just as likely to call upon fire as servitors of [[Balaxa]] are to call upon ice or servants of [[Blythe]] are to call upon toxin and disease. Trying to tell “the goodies” from “the baddies” becomes hopelessly muddled, and hardly worth the effort at that point.
...
Authored by: Jared Hindle Fantasy Alive Lore Team 2021 Copyright © Endless Adventures Ontario

Revised by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body17$),
('clerics-and-the-gods', 'Clerics and the Gods', 'Deities', $body18$“Gods? You can take them or leave them, honestly. Real people work for a living.”
...
Most gods also have other deities whose portfolio or personal history is in opposition to their own. Sometimes this is elemental, like [[Callis]], and [[Beldon]], and sometimes it is ideological, like [[Alejandero]]the god of Love opposing [[Iccula]], the goddess of Pain and Cruelty. These gods will offer power as well, but by way of temptation to stray, rather than as a boon. Some clerics have argued that subverting this power toward their deity’s own ends is a benediction to that deity… but most gods find themselves unamused by their followers seeking aid and comfort with the opposition.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body20$),
('common-threats-and-foes', 'Common Threats and Foes', 'Getting Started', $body21$It didn’t take me long to realize that the thing that was going to get me killed on adventure wasn’t going to be a blade, or the fangs of some great beastie – it was having no idea what it was that I was fighting.
...
Some servants of the gods or unscrupulous wizards may want your life for other unsavory purposes. Necromancersand servants of aggressive gods may also have an opinion about what to make of you – and you might not care for the answers.
...
There are vast stretches of terrain between territories, and in those places, some of the wildlife might decide you’re valid prey. Animals of all descriptors dot the woodlands of the Lakes Region, some of whom may have been imbued with magic from their environment. Dire animalsare like regular animals, but tend to be larger, more aggressive, and sometimes with unexpected additions to their natural weaponry. Legendary beastsare rare, but often will prove a terrible threat indeed.

Other beasts may include less familiar creatures. Gnolls are pack hunting hyena-like humanoids characterized by a high-pitched yipping noise and vocal mimicry, who will commonly assault travelers. Vrekare small bear-like creatures that scavenge and mostly eat plant life – but won’t hesitate to eat meat if the opportunity arises. Night Wormsare blind white worms, resistant to most forms of injury, and content to feast upon the dead – or make them, as the case may be.
...
True giantsare rare in the Lakes Region, but they have been spotted from time to time, often from a distance. Far more common to be found are giantkin – smaller than true giants, but distantly related through mechanisms too obscure to be certain.
...
- Bodycomponents often take forms reflecting vitality and strength; the heart of the legendary War Boar of Rincor, or a cask of whisky aged for three hundred years could both manifest as body components.
...
- Deathcomponents, as mentioned above, will often tie themselves to themes of mortality and undeath. Death spells are often aided by components manifesting in dusty skulls, mummy wrappings, and hunks of flesh, although a noose or legendary headsman’s axe could just about do the job.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body22$),
('crafting-resources', 'Crafting Resources', 'Crafting & Trade', $body23$No good blade was ever smithed of bad steel.

- Hammerfrost Dwarven proverb

Nothing comes of nothing, and every craftsperson in Ariel knows it. The skilled tradespeople of the Lakes Region excel at producing marvels, highlighting their skill and making goods that command a fine price in any market, but they need resources to work these goods.

## Raw Goods

Raw materials are born of primary industries, and while some can be used to create finished products directly, some more complex pieces require refined goods made from these raw goods.

Wood comes from trees. Often gathered in lumber camps or by individual woodcutters, it is plentiful as a resource and a primary resource of Harodom, Deepwood, and Michian. Wood is gathered using the skill Labourer: Lumberjack.

Stoneis quarried and cut from mines and quarries. Along with wood, stone is a primary building resource, and used in the construction of buildings, forges, and other utilities. It is frequently exported from Harodom, Portnos, Hammerfrost, and Ang Gijak. It is gathered using the skill Labourer: Miner.

Iron is mined, and refined using a process known as smelting. The minotaur miners of Skrulmiter produce the majority of the iron used in the Lakes Region, but the largest deposits in the region are found in Harodom, Bograker, Sorr Bukra, and the Broken Reach. Iron is gathered using the skill Labourer: Miner.

Silver and Gold are both valuable metals like iron, and are similarly mined. Both resources are considerably rarer than iron, and finding an appropriate mine is required in order to extract it from the ground. Harodom, Michian, and the Broken Reach have considerable silver deposits, but Hammerfrost, Skrulmiter, and Bograker have the majority of the gold deposits in the Lakes Region.

Hide is harvested from hunted and herded animals, either for use in fabrication directly, or to later be tanned into leather. Although some hunters claim that most any creature can be skinned for hide, decorum and the market dictate a limited appetite for hides from some animals. There are hunters and farmers in most lands, but Deepwood, Eldersire, and Ang Gijak produce the majority of hides for international sale. Labourer: Farmer and Labourer: Hunter can both be used to gather hide.

Wool is sheared from various fluffy creatures: within Harodom, this is mostly sheep, but in the mountainous ranges of Hammerfrost, great goat-like creatures simply named Herdbeasts provide similar material. Used in the creation of rope and cloth, wool is substantially traded by Michian, Splishenfellow, and Bograker. Labourer: Farmer is required to raise and keep the beasts that provide this wool.

## Refined Materials

Craftspeople taking and refining raw materials is the primary source for refined materials that can be used in crafting. In some cases, the raw materials are sufficiently abstract (or not used in any other capacity), and while raw materials are consumed, they are represented within this system as a cost in coin – the cost of gathering these materials, or of hiring others to do so.

Although listed below are the most common elements in creating an item or device, it should be noted that a great many

Tools are generally made of iron, although specialized trades may require tools that are made of other materials. While not required for every function of labourer or craft skills, many trades require suitable tools to be available in order to complete basic functions of that trade; it is difficult to cut down trees without saws or axes, and difficult to build a table without hammers and some means of cutting wood. Tools are made with the Craftsman: Blacksmith skill.

Hardware is traditionally made of iron; it represents nails, screws, washers, hinges, mounting plates, nuts, bolts, frames, wire and any and all other metal hardware that would be reasonably used in a normal crafting or woodworking capacity. Hardware is made with the Craftsman: Blacksmith skill.

Lumber is refined from wood; whereas wood is harvested directly from trees, lumber is planed and cut to make planks or other shaped wood suitable for crafting into more refined projects. Lumber is made with the Craftsman: Sawyer skill.

Cloth is woven from spun wool, cotton, or flax; cloth fabric is then used in the fashioning of garments, bedding, towels and other linens, tents, canvas, and so forth. Cloth is made with the Craftsman: Weaver skill.

Leather is tanned and refined hide; undergoing this process will often involve a hide being scraped, immersed in a bath or baths of specific mixtures, and then stretched and dried. Leather is then used to make armour, bags, various containers, belts, boots, garments, and for various other purposes. Leather is made with the Craftsman: Tanner skill.

Rope is traditionally made by spinning fibres until a dense cord is made. Although vegetable fibres are preferred in a lot of places, within the context of the local region, wool is the dominant element in a lot of Lakes Region rope. Rope is made with the Craftsman: Weaver skill.

Containers include earthenware jugs and pots, made from clay that can be commonly found in most areas in the Lakes Region, although some regions are well known for their clay deposits. Containers are made using the Craftsman: Potter skill.

Parchment is made from a variety of materials, commonly the skin of herd animals that has been scraped under tension and cut to size. Used by Craftsman: Bookbinders to create spell books and other high-quality tomes, parchment is made using the Craftsman: Parchment Maker skill.

Other particular projects, may require other basic or refined materials, or basic equipment. This listing however provides a basic understanding of what kind of materials and equipment specialists can craft, and how these systems interact.

Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body23$),
('curtainborn', 'Curtainborn', 'Mortal Races', $body24$## Introduction
...
Lovers trysts, pacts for power, distant blood reawakened, or even more strange and arcane dealings created the Curtainborn; children seen as half-mortal and half-divine. Many have a [[Celestials and Infernals|celestial or infernal]] parent, though few are lucky (or unlucky) enough to ever meet them, and this connection to the divine grants them incredible power at the cost of their mortal bodies. Curtainborn take to divine casting with incredible ease, but their physical bodies are fragile and don’t respond well to physical labour or even conventional doctoring. Occasionally outcast for their differences, a Curtainborn is just as likely to be welcomed with open arms by churches or communities dedicated to the gods. Born into nearly every society across Ariel, Curtainborn tend to adopt the culture of their youth, their only unifying characteristic is their connection to the divine.
...
A new race to the plane of Ariel, the oldest known Curtainborn recorded being born in 1976 [[The History of Ariel]] with no other Curtainborn having been seen or known to exist before this.
...
Base Mandatory Costuming of race origin required Prominent veins around the eyes: Blue, Purple, or Orange

### Racial Aging

| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 25 years | 60 years | 20 years | 260 years |

SPECIAL NOTE: Curtainborn are a young race, with the oldest being born in 1976 – you cannot be older than this. Youth: This is the minimum starting age for a given race. This is also the minimum age that can be achieved through rejuvenating spells. Elderly: This is the age when the effects of time begin to take their toll and benchmarks aging negatives for a character, eventually affecting their Life Points. Aging: Upon reaching the age indicated in the “Elderly” column, a character’s maximum LP decreases 1 Life Point for every increment of years indicated in the “Aging” column. For example, if the racial maximum LP for a goblin is 8 LP, a 42-year-old goblin character would have a maximum Life Points of 6. (A 42-year-old Goblin is 12 years over “Elderly” and, marking two increments of aging at 5 years each, reducing that characters’ Life Points by 2.) Maximum Age: Upon reaching the age indicated in “Max. Age” the character is deceased and may not resurrect.

### Nations and Lands

Curtainborns have no kingdom, nation, or empire of their own. They are found in many places across [[Kingdom of Harodom|Harodom]] and beyond, and may be born to non-Curtainborn parents of any race.

### Playing a Curtainborn

Regardless of a Curtainborn’s origin, one thing is indisputable: they are intrinsically connected to the [[The Pantheon|divine]]. Whether naturally drawn to the worship of their divine lineage, or nurtured and reared in a church chosen by others, it is incredibly rare for a Curtainborn to not be devoted to a god, even if most of their energy is focused on other pursuits. They have no real overarching cultural practices, adopting much of the culture of their mortal parents. The unifying features of the race are their divine connection and their outsider status among their birth cultures, leading many to feel the need to stick together. They often refer to each other as cousins, even when divine allegiances would suggest more conflict.
...
[[Dwarves (blurb)]]: Dwarven Curtainborn are often ostracized. While Dwarves are very loyal to family and are unlikely to abandon a Curtainborn child, they are viewed as physically weak and their difficulty in learning crafting skills leads many Dwarves to treat Curtainborn children as incompetent burdens.
...
[[Minotaurs]]: Because Minotaur have difficulty with magic a Curtainborn is considered very valuable in the protection of the Kindred. Due to their weaker stature, however, they are often incredibly sheltered and treated as precious, fragile things; not often allowed to adventure or stray far from their kin.
...
Authored by: Shoshana Watson Fantasy Alive Lore Team 2022 Copyright © Endless Adventures Ontario$body24$),
('death-and-dying', 'Death and Dying', 'Culture & Society', $body25$“It is uncomplicated theology to know that all beings capable of it will one day die. The more complicated theology is figuring out why some seem in an all-fired hurry to get there.”
...
Any living creature rendered insensate through violence, poison, accident, or any other potentially fatal source of injury is dying. Depending on how tough they are, they may die quickly or slowly – a recently felled ally may have anywhere between two to ten minutes before the breath stops short, the heart ceases to beat, and/or enough blood is on the outside to provide a serious hydraulics issue ([Rulebook](https://fantasyalivelrp.com/wp-content/uploads/2024/03/Fantasy-Alive-Manual-v13.1.1.pdf) p. 7). This may be shortened if an already dropped victim is struck again, or if the initial wound was especially grievous; in such cases, there is a scant sixty seconds before death claims them.
...
- Seek out resurrection. Capable of sensing resurrectors, spirits may somewhat discern between them, and may choose to move swiftly toward someone capable of restoring them to life.

- ‘Go Home’. Spirits fallen in distant lands may focus on a place that they think of as ‘home’, and vanish from their current location to appear elsewhere. This takes about five seconds, and the spirit may not move or undertake any other action while so focusing.

- Move on. Some spirits may choose not to continue in the world that has, at least recently, been so unkind to them. Such spirits vanish, moving on to whatever comes next – and no one who has so chosen has been inclined or able to speak to that part of the journey.

- (Non-Optional) Get mad about it. Spirits have a finite amount of time to return to life or move on to what comes next. The mortal skein is harsh on spirits, and enduring it for too long may cause a spirit to become a form of spectral undead called a wraith.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body26$),
('downtime', 'Downtime', 'Crafting & Trade', $body27$They say that waiting is the worst part. Honestly, I’ve tried waiting, and I’ve tried being charged by a battalion of ogres with clubs most the size of me, seeking to win a battle against my forces with extreme prejudice, and on the whole, waiting isn’t so bad.
...
[[Making Items]] requires materials, skill and downtime. It is better described in the specific page on making items, but in short, different items require different amounts of downtime based upon the item being sought. Item listings will detail how much downtime it takes to make an item, and items such as alchemical and herbal concoctions will have this information on their specific recipe.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body27$),
('dragons', 'Dragons', 'Other Beings', $body28$This document serves as a summary of a general understanding of dragons in the world, and how they scale to the gods, along with their interactions with mortals.
...
Authored by: Jared Hindle Fantasy Alive Lore Team 2021 Copyright © Endless Adventures Ontario$body28$),
('dwarves', 'Dwarves (blurb)', 'Mortal Races', $body29$> “In the Seventh Age, Belfur, son of Toric, King of the Kuzaak Thoth Mountains, laid down in this stone, ‘No living being may cripple Dwarven strength. Stone is of our flesh and steel our lifeblood.'” – Etched on the inner cloister of Dar Eknur
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 25 years | 65 years | 5 years | 140 years |

Youth: This is the minimum starting age for a given race. This is also the minimum age that can be achieved through rejuvenating spells. Elderly: This is the age when the effects of time begin to take their toll and benchmarks aging negatives for a character, eventually affecting their Life Points. Aging: Upon reaching the age indicated in the “Elderly” column, a character’s maximum LP decreases 1 Life Point for every increment of years indicated in the “Aging” column. For example, if the racial maximum LP for a goblin is 8 LP, a 42-year-old goblin character would have a maximum Life Points of 6. (A 42-year-old Goblin is 12 years over “Elderly” and, marking two increments of aging at 5 years each, reducing that characters’ Life Points by 2.) Maximum Age: Upon reaching the age indicated in “Max. Age” the character is deceased and may not resurrect.
...
- Rodbundar Clan$body29$),
('dshunn', 'D’Shunn', 'Mortal Races', $body30$“There are two things that you should be afraid of at night, the most important being the faint glow of the D’Shunn you don’t see.” – Ancient Proverb
...
- Bioluminescent face patterning (done with reflective paints or glow in the dark paints, etc. You can also use lights in the wig/hair.) Patterning for bioluminescence must look natural, and not resemble symbols or tribal markings
...
Youth: This is the minimum starting age for a given race. This is also the minimum age that can be achieved through rejuvenating spells. Elderly: This is the age when the effects of time begin to take their toll and benchmarks aging negatives for a character, eventually affecting their Life Points. Aging:Upon reaching the age indicated in the “Elderly” column, a character’s maximum LP decreases 1 Life Point for every increment of years indicated in the “Aging” column. For example, if the racial maximum LP for a D’shunn is 10 LP, an 85-year-old D’shunn character would have a maximum Life Points of 8. (A 65-year-old D’shunn is 20 years over “Elderly” and, marking two increments of aging at 10 years each, reducing that characters’ Life Points by 2.) Maximum Age: Upon reaching the age indicated in “Max. Age” the character is deceased and may not resurrect.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body30$),
('elieff', 'Elieff', 'Deities', $body31$The Candle Watchers The Followers of Elieff

> “At first there was nothing. Just the void, dark, empty, eternal. Time slipped ever forward for ages beyond the imagination of man. Until time itself, Elieff, Grandfather of the Gods, reached into the void and crafted six forms; His children, the High Gods. The sisters: Fiona, the lonely moon, and Atha, mother of earth, circling each other forever. Their brothers: Beldon, master of the seas and lord of water, Callis, the sun that shone upon them all, keeper of flame, and Clovis, who was to be keeper of the skies and guard, ever vigil of the void beyond. Finally, the sixth, the final child, Elieff’s one mistake, or perhaps his own subtle joke: Anajaream, god of chance and chaos, ruler of what might be, keeper of all that might go astray. And so, existence came to be. With that awesome creating Elieff retreated again to the depths of the void, watching, waiting silently for the rest of time.”
> -- Foundations 1:1
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 35 years | 85 years | 10 years | 185 years |
...
While small groups of Elves can be found almost anywhere in [[The History of Ariel]], in small homesteads, as nomadic clans or even living in far away cities, the vast majority of the Elves of Ariel can be found in one of five elvish City-States.
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/07/69055783_400807563954288_7063060592851943424_n.jpg)

Eldersire is situated just north of the Human nation of [[Kingdom of Harodom]], and has been one of their long-time trading partners and allies. Eldersire is most famous for its Guild Arcane, which is considered one of the premiere guilds of arcane learning. Apenca is venerated here more-so than in other city-states and the Great Temple of Apenca in Eldersire is a point of pilgrimage for many within the faith.

Deepwoodis located just west of the Michian empire, and has suffered many demonic incursions throughout its life that have led to a strong presence of the church of [[Clovis]]. Despite these troubles, Deepwood has been renowned as a place of learning and culture. The worship of[[Sasha]], Clovis, [[Fiona]], [[Jerroh]], [[Arkady]], and [[Iccula]] are quite popular within the city-state. Deepwood is the only Elven city-state which is not named after its governing city of Darkwood (though the names remain similar enough that they often cause confusion to travellers).
...
Elwyndyreis situated on the north-western coast of the continent, and maintains a sizable fleet of vessels with which they conduct trade down the western coast. Though they have been involved in trade disputes with other coastal territories, even once forming a naval blockade around the Human kingdom of Seacrest, they currently enjoy good relations with their neighbours. The worship of [[Beldon]] and [[Marius]] are common here, along with [[Sasha]].
...
With marriages often a legal affair, clerics of [[Brack]] are sometimes called upon to minister weddings, though Apencan clerics are just as popular with particularly lavish weddings often including both. Alejandro is worshipped for matchmaking and by people hoping to find love, but with marriage usually such a formal legal affair he is rarely called upon to preside over weddings.
...
The involvement of Apencan faithful in the pregnancy and birthing process has meant that only very rarely is a child not able to be delivered in good health. However, the frailty of Elven physiology means that without access to physicians or Apencan healers, infant mortality is a very real threat in Elven society. Most cities have hospitals especially for children to address this issue. With the return of [[The Pantheon]] many of these hospitals have been dedicated to her as well as Apenca. While the hospitals greatly reduce infant mortality it still remains a threat, and it is common practice for families to keep children at home and reduce travel until they reach physical maturity, to reduce the risks to the children.
...
[[Orcs]]:  In the eyes of the Elves,Orcs are incredibly short-lived, crude and an affront to all that is beautiful. Trade and political discourse between the two races is almost non-existent, and friendships just as rare. Elves will generally recognizeOrcs as a dangerous people for their strength, but often underestimate their intelligence, mistaking their differences in thought for a lack thereof.

[[Goblins]]:  Elves generally seeGoblins in much the same way as Orcs. The only real difference is that Elves will fully acknowledge the “underhanded, crafty” minds of the Goblin race and underestimate their physical prowess in a fair fight.
...
[[Minotaurs]]:  Minotaur are viewed by Elves as brutish and uncouth. Their lack of patience for Elven manners of discourse lead most Elves to dismiss them as unpredictable and unmanageable, good for labour but not company.
...
[[Curtainborn]]: Elves tend to interact with Curtainborn largely dependent upon their divine and mortal lineages. A Curtainborn of Apenca birthed to Elven parents, for instance, would be afforded considerably more respect than a Curtainborn of Blythe born to aDwarf.
...
- Winter Courtfairies claim that their court’s pageantry is as refined and dignified as it is to reflect the uniqueness of every snowflake, and the calm majesty of a winter’s morn… but many of their courtiers are pinched in demeanour, mean of word and deed, and viciously bitter foes.

- Spring Court fairies claimthat theirs is the purpose of life, of the world reviving after lengthy slumber, near to (but not quite at) a point of death… but the fury of spring storms, the heady wines and headier pheromones of raucous lovemaking, and the flighty nature of flower fairies suggest that their attention is easily misplaced.
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 20 years | 50 years | 5 years | 90 years |
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body37$),
('goblins-blurb', 'Goblins', 'Mortal Races', $body38$> “Stop looking at me like that, this’ll work! …and if it doesn’t, the resulting confusion will be a great distraction and then we just stab ‘em in the back. Either way, job done, right?” – Gibrock the Singed, goblin General
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 14 years | 30 years | 5 years | 70 years |
...
Goblins are, of course, famously incapable of using arcane magic – with a heavy ‘but’ at the end. Goblins can and do use [[Clerics and the Gods|clerical magic]], and many is the goblin diviner who has mystified even other seers, with strange auguries and insight into the hidden ways of the world. Too, there is nothing stopping goblins from using scrolls or potions, and many make use of these tools, either created by clerics, or purchased (or otherwise acquired) from those people who have fewer restrictions on their magical expression.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body38$),
('hemulis', 'Hemulis', 'Deities', $body39$The Brethren of the Sword The Followers of Hemulis
...
No duchy claims the City of Hoggsport; the land of the city, and several miles in each direction are Crown controlled, and while the crown’s highways and the city’s own ports feed the city its necessary intake of lumber, stone, metal, oil, pitch, fodder, animals, vegetables, fruits, grain, flour, and raw and finished goods of all descriptors, far in excess of what could reasonably be created in the lands controlled by the crown, there are nevertheless large orchards and farms ringing the city, ensuring that it is never entirely dependent upon the capability of the nation as a whole. Dotting the agrarian countryside are stone watchtowers, able to see on the rolling plains, miles in each direction.

Once within the outer walls straining to girdle the city proper, there are no end of diversions and entertainments available to visitors. Although parts of the city still show wear and travail from the war with Eldersire (2015-2018), the city has rebuilt; feats of engineering and civic pride alike, never quite what it once was, but something anew. Travellers can find comfort within proportionate to the amount of coin that they wish to spend: while all manner of people flow in to Hoggsport, many petitioners to the Royal Court are well-off, and the finest accommodations may cost a pretty coin indeed.

## The City Core

The City Core of Hoggsport follows more strict security procedures than the rest of the city, as it is home to the Royal Court, Castle Haro, and the Royal Bank, as well as street after street of homes ranging from small but comfortable town houses used by nobility and bureaucrats who visit the city infrequently, to large estates for those of the gentry who find it serves their interests to spend a significant amount of time at Court. There are few shops, but many pubs, private members clubs, and restaurants, a great number of which have private salons and rooms available for just a few coins more, and truly impressive sound-proofing.

Although the city of Hoggsport as a whole is patrolled by the City Guard, the City Core is supplemented by the Castle Guard, usually veterans with little sense of humour. Though it defies Harodom’s military tradition to fully disarm those of noble bearing, even the daggers permitted within the Core are watched with excruciating care by the Guard. It is rumoured that the area is honeycombed with discreet passageways, many running beneath the street, as newly built and renovated homes turn up old conveniences, and seek novel ways that their inhabitants might enjoy the luxury of privacy in their movements.

Castle Haro, while still impressive to gaze upon, was built first as a fortification, and then modified to allow for some comfort thereafter. It does not tower over the City Core, as some might expect, but is built more compactly, its dark grey stone and heavy oaken gates implying that someone seeking to make trouble that threatened its inhabitants might be better served exploring other pass-times.
...
The port of Hoggsport is constantly in motion, with ships burdened with cargo arriving and departing at all hours of the day. As difficult as it is to keep track of all of the comings and goings, this part of the city can be rougher than the others, and borders on the proud but poor homes that constitute the city’s slums. Ships who may bear disease, or of which there are other reasons to prove suspicion, must wait at anchor some distance from the port until healers from the Fever House have had a chance to examine their crew and cargo, often under guard. As a hub both for land and sea travel, the fear of contagion spreading out from Hoggsport is very real.

Two rotating ships of the Harodonian fleet sit at anchor in striking distance of the harbour, performing drills and prepared to defend the harbour if so needed. A large siege arsenal along the seawall does the same, and while visually impressive, this is simply another reminder that Hoggsport may have fallen in past, but intends to do so never again.

## The Eldersire War

Hoggsport was overtaken by elven forces during the Eldersire war (2015-2018), in the summer of 2016. In truth, the city fell in stages, with the rings of its defence fighting a brutal siege, and waves of invasion. As the city fell, it became subject to plunder; many pieces of public art, once proudly held in Hoggsport galleries were destroyed or taken, and their eventual fate left unknown. Much of the citizenry was evacuated by sea, and though the City fell, the royal family had withdrawn by means unknown before the City Core was taken.

The occupation of Hoggsport proved to be a tactical error for Eldersire forces, who had to commit considerable troops in order to hold the city. It is believed that Hoggsport’s Silent Guilds, the Thieves and the Assassins, may have worked on the side of the defenders – although of course, this cannot be proven, and may have contributed to the plundering of the city simultaneous to its defence.

Eventually, Hoggsport was liberated by Duke Hayden’s 18th Mounted Dragoons, supported by a number of irregular forces, and a crack team of [[Malkin]] mage-hunters, whose innate resistance to magic came as rude surprise to the elven war mages that had proven so instrumental to taking and holding the city. After an occupation of six months, the liberation occurred in a matter of three days – and the wide destruction and capture of elven forces within the city proved disastrous both to morale and fighting capacity for the Eldersire armies in the rest of the country.

## Visitor’s Guide

An unpublished [Visitor’s Guide](https://fantasyalivelrp.com/wp-content/uploads/2026/02/Hoggsport_-A-Visitors-Guide.pdf) to Hoggsport was uncovered in the recovery and rebuilding of the city, and copies of it have circulated to describe what life in the city once was, and may be again.
...
Pages are interlinked with hotlinks, and sorted into broad topic based sections. One page may be included under several sections, if the information within it is relevant to more than one section. This is intended to make it easier for people to find information that is relevant to their search.

Check back regularly, as this resource is still under construction, and more pages and information will become available as it is completed!

Learn more about…

[The Rules of Play](https://fantasyalivelrp.com/wp-content/uploads/2024/03/Fantasy-Alive-Manual-v13.1.1.pdf)

[The Peoples of the Ariel](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1013)

[Magic](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=996)

Recent History

[[Faith in the Lakes Region]]

[Common Threats and Foes](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1000)

[Trades and Vocations](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1005)

Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body42$),
('humans-blurb', 'Humans', 'Mortal Races', $body43$> “Alone we are resourceful, we survive; but together … together we can do what is thought to be impossible!” – King Lyryan Haro during the final conquest of the Kingdom of Gelria 1705 A.T.

## Description

The most populous of the peoples of the Lakes Region, humans are adventurous, industrious, and passionate. Inclined towards community, humans are the backbone of the largest cities, guilds, and empires across Ariel in the modern age. Relying on their versatility and adaptability to overcome obstacles, humans can settle in most places, and either adapt to the challenges of the lands in which they settle, or adapt the lands to their own needs.

Humans are often seen as a standard to which other species are compared; they lack the exceptional strength of the [[Minotaurs]], but take more readily to magic and many skilled crafts. While they do not have the innate affinity for magic found in [[Elves]] or [[D’Shunn]], they are more physically resilient and mightier than either. In a very real sense, humans strike a balance, neither innately specializing nor innately limited, compared to the other sapient peoples of the world. As a result, you can find humans nearly everywhere, in every walk of life, using their varied skills to achieve remarkable things.

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/975.-FAasedrgf.jpg)

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/550890_4830739849848_701951127_nsdthg.jpg)

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/358098724_10161479228943313_8033759550335485692_nsdtghbf-747x1024.jpg)

## Racial Bonuses

- Begin with 5 additional Skill Points (SP)

- Begin with 5 Life Points (LP)
...
- No specific makeup or prosthetics are required.

- Avoid costuming that could be mistaken for another race, such as false beards.

## Racial Aging

| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 17 years | 45 years | 5 years | 95 years |

Youth: This is the minimum starting age for a given race. This is also the minimum age that can be achieved through rejuvenating spells.

Elderly: This is the age when the effects of time begin to take their toll and benchmarks aging negatives for a character, eventually affecting their Life Points.

Aging: Upon reaching the age indicated in the “Elderly” column, a character’s maximum LP decreases 1 Life Point for every increment of years indicated in the “Aging” column. For example, if the racial maximum LP for a goblin is 8 LP, a 42-year-old goblin character would have a maximum Life Points of 6. (A 57-year-old Human is 12 years over “Elderly” and, marking two increments of aging at 5 years each, reducing that characters’ Life Points by 2.)
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/image-1.jpeg)
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/image-4.jpeg)
...
Cities in the Duchy of Gelrich Gelrich Windhaven Lorton Adder Point Guall [[Yorik]]
...
[[Humans]] The predominant race of the kingdom, they tend to look after their own before all others. Though humans do congregate together in this way the power struggle between them is constant.

[[Elves]] Formerly the race Humans looked to, Elves are of the older ways and do not appreciate the progress the world is making. Slow to age, and slow to change, they are nevertheless respected for their ties to Apenca, and the older knowledge they maintain.
...
Politics within Harodom are far more complex than would first appear. The political blood of the kingdom is one of conflict, deal making, and constantly seeking to better oneself, family, or the kingdom. Nobility often deal in secret and present alliances when benefit is most advantageous, or desperation leaves no other alternative. Few House alliances last generations but those that do make any opposition think twice about moving against one without suffering consequences from another. On occasion there are nobles that do not use guile in their actions, rather stating their intentions clearly and loudly, adding ironically unknown variables to the usual manner of dealings between the ruling class. When dealing with foreign nations, Harodom nobles almost always put the needs of the kingdom before anything else, and will do all they can to reap the greatest rewards, sometimes in spite of the ramifications. The lower classes delve into politics in a much different manner, often focusing on benefits for their families but directly for the communities they belong to, rather than the kingdom as a whole. Typically with more life-affecting consequences these classes are more tempered in the risks they take and will attach themselves to those with greater influence, often nobility or guilds, to improve their lot in life.

The current king and queen of Harodom are King Francis Anthony Haro and his wife Queen Drusilla Haro

NOBILITY AND SOCIAL CLASS IN HARODOM
...
The worship of the Pantheon varies throughout the kingdom and is highly dependent on the life someone leads as to which gods they will hold above another. Whereas nobility may give higher praise to [[Fiona]] whom is the official deity of the Monarch, [[Hemulis]] for battle, Marius for trade, or [[Arkady]] to enhance their lot in life, the remainder of society may pray to [[Atha]] for their crop yields, [[Alwyn]] for clear skies, [[Alejandero]] for matchmaking, or [[Sasha]] for magical miracles.
...
Legal Gods– Worship that is wholly accepted throughout the Kingdom.

Alejandro; Alwyn;[[Apenca]]; Arkady; Atha; [[The Pantheon]]; [[Bard]]; [[Beldon]]; [[Brack]]; [[Callis]]; [[Clovis]]; [[Elieff]] ;Fiona; [Jerroh](http://Jerroh); [[Marius]]; Sasha

Restricted Gods– Worship that is registered, monitored, and punishment for crimes are increased. [[Anajaream]]; [[Balaxa]]; Hemulis; [[Iccula]]; [[Kell]]; [[Strega]]

Profane Gods–Worship that is extremely restricted, monitored, and punishment for crimes are further increased.
...
The economy of Harodom comes in two fold. The nobility tend to focus on higher grade items, soldiering, and have a particular focus on luxury, warfare, magic scrolls, architecture and infrastructure. The lower classes of Harodom delve heavily into agriculture, tool implements, and other mundane everyday wares. There are also specialized [[Merchant Houses within Harodom]] who dedicate themselves to specific areas of trade and are very influential families within the Herodom economy.
...
| Nation | Shared Border | Primary Race | Relations |
|---|---|---|---|
| Sorr Bukra Horde | Northern | Orc | Enemy |
| Bog-Raker Clan | Northern | Dwarf | Friendly |
| Hammerfrost Clan | Northern | Dwarf | Uneasy |
| City-State of Portnos | Northern | Human | Uneasy |
| Eldersire Nation | Eastern | Elf | Neutral |
| Ang Gijak Horde | Eastern Water-Route | Orc | Neutral |
| Empire of Michian | Southern | Human | Friendly |
| Kingdom of Deepwood | Southern | Elf | Uneasy |
| Kingdom of Splishenfellow | Western Water-Route | Gnome | Neutral |

Terminology Ambassador – Serving a specific purpose, someone with this title is given specific rights and privileges in dealing with their assigned task, under the discretion and service to a ruling noble. Chamberlain – Gives counsel to their superior and serves primarily as the voice of the one they serve to outside parties. These servants of nobility work strictly within the borders of the kingdom, dealing with other nobility and powerful guilds. Court – The personal entourage of a noble, consisting of other nobles, clerics, mages, merchants, healers, etc. The Court of a noble is highly dependent on their own status and wealth. Emissary – Much like a Chamberlain, their function is international, serving as envoys and diplomats to foreign powers on behalf of their liege. Emissaries are sent on behalf of the kingdom itself, and will serve no noble less than the rank of a Duchess or Duke. Fealty – An oath of loyalty that would supersede any other understood loyalty. Fiefdom – The fief, or land, controlled directly by a noble which includes the lands which their serfs worked upon. First Knight – A Knight or Dame in service to their liege, marked as the highest of all Knights/Dames in their service. These nobles serve as the right hand of their liege. Hostage – A person held as security for a stated condition, hostage taking is a common tradition and practice among the nobility. The threat of execution of a successor, or family member, often keeps nobility on track to hold to their word. In most cases a hostage will be granted the protection of the House they are given to, being granted the title of Ward. Knave – A title given to a Knight/Dame stripped of their title. Liege – The noble superior to which a lesser noble or subject has sworn an oath of fealty. A Dame swearing an oath to the Queen makes the Queen the liege of the Dame; the Dame now holding the Queen first before all others. Mayor – Responsible for the oversight of a city, the mayor serves at the leisure of the ruling noble. They may have a direct hand in affairs that concern any and all aspects of city life. Minstrel – Sometimes a traveling musician, they are often found employed by a Court of a noble to play at their leisure. Their title originally meaning ‘little servant’ they are highly sought after, and typically play a type of flute, or stringed instrument. Ransom – The noble and military tradition of obtaining prisoners in order to be released for benefit, be it coin, land, or other concessions such as exchange of prisoners. Retinue – The personal forces of a noble consisting of men-at-arms, soldiers, and knights they command. Seneschal – The steward, or caretaker of a household responsible for maintaining their coffers, supplies, and oversight of daily activities. Sheriff – Responsible for maintaining peace and collection of taxes within designated lands. They serve ruling nobles and command guard forces to use at their discretion. Troubadour – A musician that sings grand tales and lifts spirits, these folk are likely to be found in taverns and town squares, sharing news of a neighbouring fiefdom, or grand adventures of a glorious Dame. Vassal – A noble serving their liege, representing them in their absence, typically in a military capacity. This can range from a Lady commanding the personal retinue of a Baron, to a Knight representing a Lady on the field of battle. Vassals may look after their own affairs, and fiefdoms, as they see fit but cannot engage in larger, external dealings if they may run counter to their liege’s interest. For instance a Lord may not declare war on a Lady without their Baroness’ express permission. Village Elder – An honourary title given to the elders within a village, they serve as the voice of the community in diplomatic matters, sometimes choosing another to go in their stead. They also settle minor disputes between neighbours that are too frivolous for the attention of the Sheriff and their guard.
...
Third of his name, King of the East Duranians, Gelrians, and Anchorians: The Duellar, The Hidden Bastard, Wolf Slayer, Fist of Hoggsport. The reign of King Justynyan Haro III was rife with conflict. Arguably the most violent time in Harodom’s history there were a multitude of wars that took the entirety of the attention of the King. Throughout his time King Justynyan Haro III oversaw two wars with the Empire of Michian, the uprising of New Harodom, and no less than two Beast Revolts, all in the span of the final 10 years of his rule.
...
The King too unwell to rule, Queen Ephiny Haro took control of the throne and continued in her husband’s absence. A follower of Hemulis she took control of the kingdom with decisive action with Dame Alexis by her side, who became the most reputed of warriors within the Kingdom. King Justynyan Haro III was moved to a safehouse and disappeared while the Jagari Rebellion and Estovic invasion were underway. The Estovic War ended as decisively as it had begun; rumours state that Hemulis himself smote the invaders of Harodom to the point where their forces would be crippled for decades. Duke Jagari was soon ousted as a cleric of Stasa and defeated by Her Majesty’s forces with due prejudice.
...
First of his name, King of the East Duranians, Gelrians, and Anchorians: The Generous, The Untested, Little Maggie, The Prince of Peace. Queen Drusilla Haro – Reigning Monarch – 2017-Present A.T. First of her name, Queen of the East Duranians, Gelrians, and Anchorians: The Phoenix Princess, Sun of Syra, Vixen of Valoriel, The Younger.
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 16 years | 40 years | 2 years | 70 years |
...
The Lizardfolk of Ariel are hearty and adaptable, with most of their permanent settlements in lands that are too hostile or too remote to be conquered. Freed from the need to defend themselves, the Lizardfolk who choose such settlements pursue their philosophy, art, or style of combat without significant concern of the depredations of hostile nations or even most monsters. From the perspective of others, the Lizardfolk are simple, inhabiting scrubland that nobody would reasonably desire.

Those that eschew permanent settlements have gathering points in the lands through which they cross, where they can usually be found at different parts of the year. These nomadic Lizardfolk are often more marked by time and their travels, but tend to be more sociable and have more trappings of wealth about them, often serving as travelling merchants or traders in the lands through which they venture.

- Blackmire – The dark waters of Blackmire give the lands their name; a large swamp through which a millennia-old mangrove knots and twists, making travel for the uninitiated treacherous and confusing. The Lizardfolk who make the Blackmire their home know of several large caverns in the Mire, where supplies can be stored, and which remain warm and well-ventilated enough for most of the Folk to winter within. Blackmire Lizardfolk have a large population of [[Jerroh]] and [[Atha]] priests among them, and some of those faiths make pilgrimages to visit and train with the Folk – if they prove worthy.

- Thornmallow Isle – A large island into the West Sea off the western shores of Ariel, Thornmallow Isle is temperate the year round, and is a largely agrarian society tended to by the Lizardfolk that live there. The Folk of Thornmallow are thoughtful and reflective, in no hurry to be anywhere or go anywhere with any real haste, with their dominant faith being that of [[Elieff]]. The herbalists of Thornmallow Isle sell small shipments to mainland settlements – when they need things that they cannot produce themselves.

- The Moors of Oolm – A massive peat bog, the Moors of Oolm were, in ancient times, the site of a great battle. The dead lie, naturally mummified by the chill and caustic waters, beneath the massive peat which the Lizardfolk cut for fuel and trade. The Lizardfolk dwellings are houses on stilts, for while brief exposure to the water is not terrible, metal swiftly corrodes from the Breath of Oolm. It is rumoured that among the Folk that live in the Moors, there are some necromancers who control the dead, keeping them dormant – unless needed. The Folk of the Moors will occasionally venture forth, often bearing with them relics recovered during their fishing or other business in the waters beneath, returning them to the nearest representatives of the species of they that had it in life.

- Firewatch Bay – Sitting in the caldera of Mutterpeak, the Lizardfolk settlement of Firewatch Bay are friendly to strangers, with a strong presence of Callis priests of all species present, in patient watch over the place where the Mountain Fire incident once drove off orc and goblin armies, when the gnomes deliberately ignited the volcano. The area is rich both in farming and minerals, and the Lizardfolk that hail from Firewatch Bay say that living in the shadow of such destructive history makes their lives filled with meaning: the reminder that life can be brief and swiftly overturned is everpresent, and makes them appreciate the now.

- Askala – Hidden within the [[The Deeps]], this enclave is surrounded by thick sulphurous vents whose output feed the rich and often toxic gardens of mushrooms and strange mosses that feed the Askala fortress. The Lizardfolk from here are pale and have strange eyes, and it is rumoured that they guard the fortress against those that would plunder a relic hidden within. The Lizardfolk will not say, and perhaps most do not even know – but they will trade the poisons that they ferment to the nearby [[D’Shunn]] cavern of Serozarran.

- The Trackless Salts – Not a singular settlement, but a number of semi-nomadic groups that circulate through the Great Southern Desert separating most of Ariel from the [[The Southern Kingdoms]]. The Lizardfolk of the Trackless Salts will often trade in semi-precious stones for wood and cloth, but no outsiders are welcome within their camps or those few areas where they have set up a semi-permanent residences, laying claim to some of the few oases needed to survive within this inhospitable environment.

Of course, there are as many or more Lizardfolk who do not settle down – these roving groups follow instinct and ancient traditions, crossing Ariel and pursuing any of the common callings that so mark the lives of the rest of Ariel’s residents.

## History

If the Lizardfolk are even willing to speak with outsiders about the origins of their species, it becomes immediately clear that details conflict. Many Lizardfolk claim that they have a strong connection with the elemental gods, [[Atha]], [[Callis]], [[Beldon]], [[Alwyn]], and [[Balaxa]], and it is from this that they derive their strong connections to nature and natural resilience. Still, whether this is just a manifestation of pronounced faith or an actual origin story is hotly debated, even among the Lizardfolk themselves.

What can be confirmed is that Lizardfolk were among the first sapient species, with the oldest Lizardfolk settlement ruins dating back to thousands of years before the tear. Although some Lizardfolk claim that their ancestors were dragons, it seems that there is little evidence supporting this, and Lizardfolk scholars, shamans, and sages view such a viewpoint as self-aggrandizing nonsense. During the time of the Golden Empire, Lizardfolk settlements existed both within and outside of the Empire’s control, and a famous tablet surviving from the age of the Empire suggests that imperial bureaucrats weren’t quite sure what to make of the Folk.

The Lizardfolk, although having little use for written languages, do have a common writing that mostly takes the form of complex hieroglyphics, used by alchemists, wizards, and other scholars who need little shared writings with representatives of other species. In place of this, the Lizardfolk oral tradition tells of the period between [[The Tear]] and the second age of reason, describing the affairs of other sapients from an outsider’s perspective.

The Lizardfolk themselves apparently settled several large cities during the Age of Blood, only to see them fall under siege to minotaur and orc forces. The Moors of Oolm are a settlement upon a battlefield just outside of the City of Oolm, which now lies wholly abandoned, and thought to deeply haunted, by the offensives and counteroffensives that brought low the city’s walls. As their strongholds fell, those who fled the cities took up with the more nomadic and dispersed settlements of their kinfolk, and it is in such locations that Lizardfolk herbalists developed some of the strong blended mixtures that now define contemporary herbalism.

Lizardfolk did not enter the Continental Trade Agreement until considerably after the first such agreement was signed, in 1852 A.T., and most of the Lizardfolk nations did not enter even then. Only Blackmire, Oolm, and Firewatch Bay entered into the trade agreement, along with two of the larger nomadic caravans. Mostly the reclusive Lizardfolk kept their own counsel, intervening in worldly affairs only intermittently, and when inscrutable signals from the Heavens or the Web of Fate so bade them.

## Culture

As many Lizardfolk find phonetic writings to be unintuitive, and their own written language complex by its very nature, Lizardfolk have a strong oral tradition of history and storytelling. Lizardfolk storytellers are famed for their long and expansive memories; years of training go into the perfect recitations of history, from which no deviation is permitted. Those who tell stories for entertainment are allowed colour and elabouration, even on traditional stories; the Lizardfolk recognize the value of a tale well told in enjoyment or moral education, but insist upon word-perfection for the recounting of history.

Lizardfolk musicians favour complex rhythms beat out on complex sets of toned drums. Many also favour woodwind or stringed instruments, and their songs often interweave with their storytelling, offering verse and meter to measure out the feet of a complex tale. Shizzlas Songweaver, a famous Lizardfolk minstrel, is said to have composed a beautiful opera that tells the tale of the Tear, passed down through generations of Lizardfolk, with an aria that is said to have been able to make a statue weep – only for the unusual circumstances of their death leading to their family burying the work, fearing it to be cursed.

Lizard visual art will often tell a story, with many visual artists among the Folk being at least somewhat familiar with the complex pictographic language of their people. Indeed, in some ways, Lizardfolk tapestry and murals could be described as a form of poetry; rich in meaning, the images worked into the art tell a through-line narrative that sums up the emotional or cultural significance of the piece.

## Faith

Although many Lizardfolk struggle with the written languages required to work as wizards and alchemists, there is a strong undercurrent of deep and abiding spiritualism in most places where Lizardfolk gather. Some groups cleave quite tightly to the elemental gods, but there are few restrictions on what faiths the Folk may gravitate toward – except for cultural taboos, usually local, but some widespread such as distaste for the worship of [[Stasa]], goddess of unnatural death and undeath.

Among those found in the more permanent settlements are Lizardfolk quite adept at pickling and fermenting, and consequently, within them has been something of a renaissance of the worship of [[Blythe]], deity of disease, rot, and poison. Although those who inflict disease within their settlements are still outcast, the teachings of Blythe are applied to the brewing of alcohol and preservation through fermentation and salting. This is not often spoken of with outsiders, who naturally fear the hand of Blythe in any settlement.

## The Antisidereals

It is not uncommon for some Lizardfolk to seek a life outside of the nomadic bands or nations of the Folk. Many will find their way back, but there are legends of the antisidereals, those whose deeds are not foretold in the weave of Fate or the movement of the stars. Such Folk often grow powerful indeed, and rarely spend any great amount of time living comfortably; chasing adventure, and forging their own path, as none has been laid for them. Powerful seers have said that such Lizardfolk have no defined fate, and that it simply sloughs from them like shed skin.

Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body50$),
('magedom', 'Magedom', 'Kingdoms & Regions', $body51$“Girt by sea, and bordered to the west on the mainland by the Dark Forest, the island nation of Magedom is a place of magic and wonder. Powerful wizards work magic without parallel among mundane crafts, and each of the Great Houses has secrets as they seek to advance the mortal understanding of magic. Every day, new discoveries and magic and… wonder. I never, ever, want to go back.”
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body51$),
('magic-items', 'Magic Items', 'Magic', $body52$Traipsing through an abandoned wizard’s tower is always taking your life into your hands. Not only do you have to worry about the traps and magical protections that the wizard gotright, you’re in just as much danger – or more! – from the projects that were left on the hob for whenever the wizard got back to it.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body52$),
('magic-overview', 'Magic in the World of Fantasy Alive', 'Getting Started', $body53$The world of Fantasy Alive is touched by magic, with mortals across all the varied civilizations in the world having complex relationships with this powerful energy. Through study, divine endowments, and careful observation of the world around them, scholars, priests, and soothsayers have learned to harness some of this power, and to use it to perform tasks more readily than would be possible without magic – and in some cases to perform tasks that would not be possible at all. Conversely, some creatures have developed or been created with natural powerful magic of their own, and use it as innately as any other natural ability.

## Wizards

The study of Magery gives wizards access to natural magic that flows in great invisible patterns through the world. By resting in concentrated nodesof magic, or by drawing in magic through meditative study of the magical writings in their spellbooks, wizards can draw magical energy into themselves, then shape it and expel it into the world with magical incantations and gestures. Although the incantations are nonsensical to those who have not studied magery, the effects of these spells cannot be denied. A wizard may cast any spell to which they have access to the formulation and required energy and components, making more senior wizards extremely versatile if they have time to prepare for a situation.

Mages may learn new spells either by study of spells in spellbooks, or through independent study and arcane research. Such study may be expensive, and the great [Guild Arcane](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1018) is considered a powerful authority on matters of magic, as well as a teacher in arcane disciplines – an authority that they have leveraged into considerable political and financial power.

## Clerics

Servants of the gods, the faithful of Ariel work to improve their degree of Clerical Investment with a divine power. Through prayeror acts of devotion, a cleric build up an internal reservoir of spiritual energy, and can use this to call upon miracles granted by their god, or by gods allied with their god. There is also the temptation to stray from their faith; gods opposed to a cleric’s patron may also offer miracles, although accepting this offer may open them to scorn from their own, spurned deity. The prayers used to call upon these miracles are in an ancient tongue known only to those who have spent time studying theology.

Each god has different interests in the world, and although their power is not difficult to tap into, it is granted with the understanding that a new cleric seeks to further those interests. Priests who put their own interests above those of their patrons are unlikely to rapidly gain in power, and may face censure – especially if their actions directly contradict the god’s portfolio of interests and powers. On the other hand, shrines and churches to the gods are often gathering points, where priests can meet like-minded acolytes and faithful, building mundane and mystical power through the association.

## Diviners

Soothsayers and seers, practitioners of Divinationare said to be students of the “subtle arts”. With magic focused around gaining information and delicate manipulations of the mind, diviners open their minds to the subtle play of the magical fields around them, and use complex rituals to work magic without ever drawing in magical or spiritual energy. This can mean that diviners are more difficult to spot, although they will carry around mystical foci, objects that help them to perform their rituals.

While divination magic does not necessarily benefit from the combined efforts of multiple practitioners on a singular task, it is not uncommon for diviners to compare notes and share information, allowing them to appear as if they are all-knowing. Powerful diviners are said to cast powerful spells that allow them to alter memories, or even see glimpses of the future.

## Other Magic

Still further forms of magic flow through Ariel, changing the tides of history and manifesting in strange and unusual ways.

Innate Magicis more often an aspect of what a creature is, than what it can do. A mystical defence against a hostile world, or a result of living in an area rich with magic, innate magic seemingly requires no incantation or learning for a creature to manifest, although they may only be able to work that magic a limited number of times in a day.

Magical Componentsare items that have become imbued with magic through exposure or by careful dint of effort by master craftspeople. Varying in power (and rareness), these magical components will fetch a pretty sum from spellcasters, as they are key to unlocking the most powerful spells commonly available.

Circle Magicis the common term for spells that cannot simply be cast as battle magic, requiring an elabourate set-up often including carefully inscribed glyphs and circles. These spells can have monumental and world-shifting effects, or may cause more familiar magic to behave in unusual ways. These circles are dangerous, and disrupting their patterns carelessly can have unexpected consequences.

## Learn More About…

[The Guild Arcane](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1018)

[[Faith in the Lakes Region]]

[Divination](https://fantasyalivelrp.com/?post_type=epkb_post_type_1&p=1025)
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body54$),
('malkin-blurb', 'Malkin', 'Mortal Races', $body55$> “Seek, first among all other things, one truth; that all who were born unto this world deserve their opportunity to find freedom.” – Alith-Handar, First Among the Free
...
- Wrightsare Malkin who have primarily focused their interests and efforts in fine craftsmanship. Jewellers, smiths, leatherworkers, armourers, weaponsmiths, and even alchemists, the wrights wish to keep the skilled trades that they spent much of their lives working alive.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body55$),
('marius', 'Marius', 'Deities', $body56$The Coin Talkers The Followers of Marius
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body57$),
('merchant-houses-within-harodom', 'Merchant Houses within Harodom', 'Kingdoms & Regions', $body58$### House Toth – Founded 1927 A.T.
...
A merchant house from Michian, they specialize in magical items and components. Not much is known about the house itself; however their popularity often falls hand in hand with the political views that the nobility of Harodom take on the Empire of Michian. House Ramsey is recognizable by their black and yellow tabards, with a yellow ‘R’ as their sigil.$body58$),
('minotaur-blurb', 'Minotaurs', 'Mortal Races', $body59$> “The next person who calls me a cow will die much slower than that man.” – Marthoon the Black
...
Bloodhunt: “Through the Hunt, we find ourselves.” Mercenaries and bounty hunters, the Bloodhunt minotaurs believe that the strength of Minotaurs as a species lies in the steel that they carry, and the blood that they shed. The Bloodhunters t rain hard and expect to be well paid for their hunts. It is well known that one does not hesitate to pay a Bloodhunter the agreed upon amount when a job is completed; such a breaking of one’s word is known to make you a target for the next clan’s Great Hunt. For a Bloodhunter, the hunt is the purpose of their life, and the payment is a means by which they can sustain themselves to the next hunt. Iconography: A red pawprint.

Earthguard: “Who destroys the earth’s splendour destroys themself.” Rumoured to have been started by a wayward group of the Greenchild kindred, the Earthguard are a clan dedicated to defending the wild places of the world, those untouched by the greed and exploitation of society. The Earthguard consider these places sanctuaries of the [[Atha]], and think of themselves as her sworn guardians. Keeping within these wild places, the Earthguard are only known to venture out for two reasons: to send scouts throughout the world to seek more such sanctuaries, and to bring their wrath upon those that would destroy them. When a nobleman in Michian set fire to a forest to flush out rebels from the woods, it is said that he survived to defeat his foes – only to be crushed by the ferocity of the Earthguard in the week that followed. Iconography: A shield with a leaf at the centre.

Goldenwheel: “In value, worth.” By far the wealthiest of all minotaurs, the Goldenwheel kindred are merchants and traders, taught from birth the rites and customs of all civilized lands within the catchment area of the local merchants. Intimately familiar with both legitimate and shadier mercantile connections, parts of the Goldenwheel minotaur kindred are unabashed slavers, although the Kindred as a whole denies any knowledge of such activities when operating in lands such as Harodom where the practice is frowned upon. Other kindred often view the Goldenwheel approach to matters as a necessary evil – after all, these effective merchants are the primary source for goods that other minotaur groups have difficulty internally sourcing. Even outside of minotaur circles, the Goldenwheel are known for driving a hard bargain, and also as a group that you really don’t want to cheat. Iconography: A golden wheel.

Greenchild: “Born of the earth, borne by the earth, returned to the earth.” Devout followers of [[Atha]], the Greenchildren are a peaceful kindred – by and large. Capable farmers, they use their exceptional physical prowess and strength to work enormous farms and cultivations, tending some of the most fertile fields in the world. For all of their recorded history, the Greenchildren have been all but pacifists, leading to their exploitation by conquerors and slavers seeking to take their lands and make them their own. No less capable as warriors than any other minotaur, Greenchildren have been known to heal those that they defeat in battle, taking from them weapons and armour, and sending them on their way. This said, the Greenchildren have also been known to show up without announcement and aid farmers in their vicinity who have undergone hardship or whose farmers are threatened or challenged by natural disasters. Iconography: A green oak leaf with a red spot in the middle.

Scrollbearer: “Liberty and strength through enlightenment.” Once the smallest of the major minotaur kindred groups, Scrollbearer has only recently been displaced by one of their own offshoot septs, the Ringforger kindred. Scrollbearers are a clan that believe that the power of the mind is greater than the power of one’s body. Almost all Scrollbearers are scholars, priests, or mages, and although their numbers are few, they are well respected among most of the other kindreds for their wisdom and power – save perhaps for those that think that their focus on scholarly pursuits turn them from the paths of physical strength, and consequently disdain them. Iconography: A scroll and key.

Ringforger: “We craft the wings that will give us flight.” The most recent kindred to be acknowledged by the other major kindred groups as a force to be reckoned with, Ringforger minotaurs refuse to shy away from the hard work that goes into learning the arts and artifice that are typically more difficult for their fellow minotaurs. Although only recognized as a major kindred group in 2021, Ringforger weapons, armour and mixtures have appeared on the battlefields in a support role for well over a century. The Ringforgers believe in craft for its own sake, but many have formed relationships with merchants from Goldenwheel to sell the acme of their art – helping both groups make substantial fortunes. Iconography: A ring over a crossed hammer and awl.
...
![A depiction of the kingdom of Harodom, its duchies O'Shea, Dwawain and Gelrich, and the surrounding nations](https://fantasyalivelrp.com/wp-content/uploads/2023/10/image-4-1024x730.jpeg "The nations of the Lakes Region")
...
Eldersire’s primary faith is [[Apenca]], although [[Sasha]]is well represented among the various cities in the League, as Eldersire is the current home of the [[The Guild Arcane]]. The Guild, as well as Eldersire’s leadership, are much diminished following a multi-year, costly war with neighbouring Harodom, started by a border dispute, and ended only after much loss of life and materiel. Although Eldersire nationals may travel freely to Harodom, different city-states within the League have varying views on Harodonians visiting in return.
...
While smaller settlements are less likely to have regular newspapers, where they do crop up, literacy – and those valued trades that require it – tends to be more common. Somewhere between a town crier and a village gossip, passing around a paper over a mug of ale or a cup of tea is as good a pass-time as any.

## The Yorik Bee

The first newspaper printed in the town of Yorik, the Yorik Bee only had a few editions printed, and was a community paper started sometime around the founding of the Yorik in 2004. Although no copies of any of these early papers are currently available, this record is more than happy to make them available if any should surface.

The press for the Bee was salvaged when later papers in the region were started, and the mechanisms form the basis for the current newspaper.

## The Yorik Eye / The Yorik Adventurer / The Adventurer

Named initially for the Eye of [[Fiona]], The Yorik Eye was started by Oren D’vann in January of 2017, as a way to keep public record of events, provide commentary, and entertainment and diversions for the people of Yorik. After a few false starts, the paper was rebranded ‘The Yorik Adventurer’, a name it bore for some years thereafter. Following the departure of most of the adventuring population of [[Yorik]] with the conclusion of the War of the Twins and destruction of the Undercity, the paper was once again rebranded, this time simply as ‘The Adventurer’, following the movements of those same adventurers, and serving both as a newspaper and a trade journal.

Too many Yorik (and former Yorik) yeomen and citizens have contributed to The Adventure to list briefly, but the paper and its editor are eternally grateful to those that have helped this paper to find success, a readership, and a place in this world.

Although not all papers have been saved, the following are those papers that remain archived at the Yorik Print Shed.

[January 2017 A.T. – Yorik Eye, vol 1, ed 1](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Jan-2017-3.pdf) [February 2017 A.T. – Yorik Eye, vol 1, ed 2](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Feb-2017-3.pdf)

A substantial block of missing papers

[September 2019 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Sept-2019-1.pdf) [October 2019 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Oct-2019.pdf) [November 2019 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-NOV-2019-1.pdf) [December 2019 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-DEC-2019-1.pdf) [January 2020 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-JAN-2020-1.pdf) [February 2020 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-FEB-2020.pdf) [March 2020 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-MAR-2020.pdf) [April 2020 A.T. – Yorik Adventurer “Fates” Edition.](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-FATES-2020.pdf)

Missing Papers [March 2021 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-MAR-2021-1.pdf)

Missing Papers

[May 2022 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-MAY-2022-1.pdf)

Missing Papers [August 2022 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-AUG-2022-1.pdf) [September 2022 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-First-September-2022-1.pdf)

Missing Papers

[June 2023 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-JUNE-2023-01-2.pdf) [July 2023 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-JULY-2023.pdf) [August 2023 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-August-2023.pdf) [September 2023 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-September-2023.pdf) [October 2023 A.T. (1) – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-OCT-2023-1.pdf) [October 2023 A.T. (2) – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-OCT-2023-2.pdf) [November 2023 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Nov-2023.pdf) [January 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Jan-2024.pdf) [March 2024 A.T. (1) – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Mar-1-2024.pdf) [March 2024 A.T. (2) – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Mar-2-2024.pdf) [April 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Apr-2024.pdf) [May 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-May-2024.pdf) [June 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-June-2024.pdf) [July 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-July-2024.pdf) [August 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-August-2024.pdf) [September 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-September-2024.pdf) [October 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-October-2024-Short.pdf) [November 2024 A.T. – Yorik Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-November-2024.pdf) [January 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Jan-2025.pdf) [February 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-Feb-2025.pdf) [April 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-April-2025.pdf) [May 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-May-2025.pdf) [June 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-June-2025.pdf) [July 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-July-2025.pdf) [August 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-August-2025.pdf) [September 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-September-2025.pdf) [October 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-October-2025.pdf) [November 2025 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-November-2025.pdf) [January 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-January-2026.pdf) [February 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-February-2026.pdf) [March 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-March-2026.pdf) [April 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/04/FA-Newspaper-April-2026.pdf) [May 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/05/FA-Newspaper-May-2026.pdf) [June 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/06/FA-Newspaper-June-2026.pdf) [July 2026 A.T. – The Adventurer](https://fantasyalivelrp.com/wp-content/uploads/2026/07/FA-Newspaper-July-2026.pdf)

## The Scarsinvale Saga

The first edition of the Scarsinvale Saga was a specialized print run requested by residents of the town of Scarsinvale in the Broken Reach in commemoration of the defeat of a powerful fae entity. With an open line of communications, events in Scarsinvale were conveyed by letter and in some cases with fully written articles to the print shed in Yorik, where the paper was printed. At present on hiatus, it is possible that the Scarsinvale Saga will return.

[August 2023 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-August-2023.pdf) [September 2023 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-September-2023.pdf) [October 2023 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-October-2023.pdf) [May 2024 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-May-2024.pdf) [June 2024 A.T. (1) – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-June-2024.pdf) [June 2024 A.T. (2) – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-June-2-2024.pdf) [August 2024 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-August-2024.pdf) [September 2024 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-September-2024.pdf) [September 2024 A.T. – The Griffton Grifter](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Griffton-Grifter-September-2024.pdf) [October 2024 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-October-2024.pdf) [May 2025 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scainsvale-Saga-May-2025-Edit.pdf) [June 2025 A.T. (1) – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scarsinsvale-Saga-June-2025.pdf) [June 2025 A.T. (2) – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scarsinsvale-Saga-June-2-2025.pdf) [August 2025 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scarsinvale-Saga-Aug-2-2025.pdf) [October 2025 A.T. – The Scarsinvale Saga](https://fantasyalivelrp.com/wp-content/uploads/2026/04/Scarsinsvale-Saga-Oct-2025.pdf)

This Collection Authored and Edited by: Andrew Dunlop The Adventurer and Saga Papers were the product of a diverse group of players based upon events occurring in-game at Fantasy Alive events. Except where otherwise specified, contributors retain authorship of submitted articles, which were submitted for the purpose of producing the papers listed above. Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario

No part of this article, nor the linked documents may be used for the training of large language models.$body61$),
('nodes', 'Nodes', 'Magic', $body62$Magic flows through the world in great complex patterns that permeate the sky and the earth. In some locations, magic is concentrated, flowing through and down into a ‘node’ – a location that draws in the energy and makes a small area more magically enriched. Wizards, and other beings capable of absorbing, holding and harnessing magical energy can regain energy simply by spending time in these areas, making them highly prized locations. Often, whether or not a new settlement proves viably capable of growing past a certain size, will depend on whether it can sustain arcane spellcasters – and a node is extremely useful to such people.

Nodes are typically between ten and twenty feet across, although larger and more potent nodes do exist. Spellcasters who train themselves to be a Catalystfor magical energy are better able to make use of the concentrated energy around a node.

## Normal Nodes

Most nodes represent a deposit or vein of mithril in the earth, drawing in and neutralizing energy from the environment around them. As the energy is neutralized, the mithril’s capacity is slowly used up, and as it processes the energy, more magical energy can be absorbed. Drawing all of the energy out of a node, or discharging a great deal of energy into a node, can interrupt this flow, suspending the function of a node until such time as the normal flow reasserts itself.
...
Nodes can technically be formed by a great many different means, and primarily require some kind of focus that can be used to draw energy together in a concentrated and organized manner. Spirit Nodes are one such example – often found at the grave or burial place of a powerful arcane spellcaster who took pains in life to ensure that their body was optimized for the drawing and processing of magical energy, some part of the spellcaster’s spirit remains at the location, creating a node with their body and spirit together.

Other unusual nodes may occur by other means, but study into this has not been well documented, if it has been performed at all. It is possible that some unusual nodes may also have other unusual impacts on the world around them, such as a thinning of the Curtain that separates the world of Ariel from the next, or causing unusual plant and animal life to form in the vicinity of the node.

Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body62$),
('orcs-blurb', 'Orcs', 'Mortal Races', $body63$> “To bleed is to grow. It is through hard trial we find the weaknesses that must be cut out so that we might heal stronger.” – Chieftain Stora Truetongue
...
| Youth | Elderly | Aging | Max. Age |
|---|---|---|---|
| 15 years | 40 years | 2 years | 70 years |
...
The Banner of Steelis one of the largest banner-groups in modern day Ariel. It represents those orcs who believe that through martial pursuits, the orcs can best ensure their survival, and negotiate with other lands from a position of strength – if they don’t simply seize what they want.

The Banner of Fire represents most of the faiths, and holds that it is through fierce and determined faith that orcs can best build a future. Banner of Fire orcs who hold [[Clerics and the Gods|clerical investment]] tend to be zealous in their belief, and while it is not unheard of for Banner of Fire orcs to come from opposing faiths, it’s also not unheard of for them to come to blows over matters of belief.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body64$),
('ruins-of-the-lakes-region', 'Ruins of the Lakes Region', 'Getting Started', $body65$Exploring a ruin, there are some things you should keep a wary eye out for. Giant spiders have been known to nest in any reasonably dry, sheltered area, places where something truly awful happened tend to generate undead by the score, and the people who lived there might have had creative thoughts when it came to home defence. If you find a place that’s pretty well picked-over, it’s disappointing but safe. If there’s treasure still to be found, the cautious wanderer might well ask… ‘why?’
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body65$),
('sasha', 'Sasha', 'Deities', $body66$The Divine Mages The Followers of Sasha
...
Barring proximity to a holy site, or being an entirely faith-based settlement, a small hamlet might have one, or perhaps two invested clerics [[Faith in the Lakes Region|of any faith]], with perhaps an acolyte learning the ways of faith. While exceptions certainly exist, it is difficult to sustain too many full-time clergy within a limited area, although there may be several lay-followers of any number of religions, marking personal observances to the best of their abilities. Most often, the most dominant faith will pertain to the nature of the settlement – fishing villages will often have shrines to [[Beldon]] for example, and farming, forestry, and mining all receive some measure of blessing from [[Atha]].
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body67$),
('special-materials', 'Special Materials', 'Magic', $body68$The lych’s hand drew back, and when she pointed, a bolt of dark energy, crackling with power and surely fit to kill whomever it struck, lanced forth. Kaelos leapt before the bolt, and it caught him in the chest, the impact throwing him back against the wall. But impossibly he rose, his doublet and tunic burnt away, to reveal the glint of metal beneath, a metal that had surely saved his life. A waistcoat of mithril had dissipated the magic harmlessly – and Kaelos drew his blade, and charged again.
...
In anticipation of conflict, a great sea-gate was designed to guard the harbour, but while much has been spoken of its completion, only the great carved pillars were ever built, statues enormous in height that would, should the money ever become available, hold a gate to stave off seagoing adversaries. Dotting the harbour are the much more financially practicable siege engines that require comparatively limited maintenance, and harden Stelton as a target unworthy of most invaders from the Lake.$body70$),
('strega', 'Strega', 'Deities', $body71$The Cult of the Wyrm The Followers of Strega
...
The symbols of Strega include a vial of blood, a fang and an animal scale.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body73$),
('the-deeps', 'The Deeps', 'Cosmology & Planes', $body74$“The dark places of the world hold many creatures, some of which only the D’shunn dare to brave; the venomous lava crabs, the flesh-eating mushrooms, the lightning serpents. Of course, most people only remember the spiders, but they’re dangerous enough that none of the rest are likely to get too offended.”
...
Authored by: Jared Hindle Fantasy Alive Lore Team 2022 Copyright © Endless Adventures Ontario$body76$),
('the-pantheon', 'The Pantheon', 'Deities', $body77$This document will be a summary of the FA Pantheon, how they interact with the world, and how they function altogether.
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/10/image.png)
...
![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/11/00020231028_145331-411x1024.jpg "Averill")

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/11/00020231028_150431-388x1024.jpg "Marowit")

![Lore illustration](https://fantasyalivelrp.com/wp-content/uploads/2023/11/0020231028_150338-386x1024.jpg "Guardian")

Authored by: Jared Hindle and Shoshana Watson Fantasy Alive Lore Team 2023 Copyright © Endless Adventures Ontario$body77$),
('planes-summary', 'The Planes of Existence', 'Cosmology & Planes', $body78$The purpose of this document is to explain the existence of different planes within the world at large in very general terms.
...
Most planes fall under some sort of rulership. Many planes are the domain of a particular god, though other beings of power may have their own domains as well, often within or part of a greater plane, like nobles ruling in a kingdom. Some domains span across multiple planes. Notably there are two planes that appear to be unique in that their domains are not ruled over by a specific deity or entity: the Faw Plane and the Mortal Plane.
...
![Lore illustration](https://lh4.googleusercontent.com/uCs-u2AiPQwDwRtMHZuZwIXhEMzyBkhWgBtmmCFCadbxaEHJuJPdCQ35_fA6oUN9sqEwYz0VvepMamK0wMF5cHZlkSIsjJrHKMGq6HsilBTQagjCeDNI8uu0uEbA4W1-ZYf_KsH22F4-evE6DGMZ1r4)
...
![Lore illustration](https://lh6.googleusercontent.com/fCsvVoRCmSfG6qVMnjsvZ_f756v3oGPKVFXiw-qX7CJszQwUqEC9xwhM5l-DyMSU3_GksLs-Lg-M3JblX2_INZBbxGoGnRGtsr6HrA7zYCsdV2Y8841ZnTmXbOH0YBLd_qzoLynQWXbNS7qA5rN6cVM)

Authored by: Kam Purvis & Elizabeth Cameron Fantasy Alive Lore Team 2021 Copyright © Endless Adventures Ontario$body79$),
('the-silent-guilds', 'The Silent Guilds', 'Kingdoms & Regions', $body80$“What’s there to say of the silent guilds? The thieves – oh, they’ll take your coin, your valuables, everything that you own, if you watch it not carefully enough; it’s all implied in the name, and while wehear about the thieves that get caught, there must surely be a fair few who are never captured, or even detected. Then, there’s the assassins. They’ll take something a bit more precious than your purse – especially if you spill your guts about what you know of them.”
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body82$),
('the-war-of-the-twins', 'The War of the Twins', 'History', $body83$“Sing, minstrel, of the Twins, Sarna, Render of Cities, and Tivolous, The Betrayer. Sing of their lust for conquest, their mad aspirations to godhood – and yes, sing too of their defeat, won at great cost. But defeat and destruction are not one and the same, so sing too of what came after…”

- Prologue, The Tragedy of The Twins (2022 A.T.)

The War of the Twins is thought to have begun in 1502 A.T., when two [[Elves|elven]] twins identifying themselves as Sarna and Tivolous made known that they had raised armies of the [[Undead|undead]] and of [[Celestials and Infernals|infernals]]. Using these forces, and their own powerful magics, the Twins quickly assailed the nation of Deepwood, starting with the great city of Darkwood, likely in an effort to stem opposition from the powerful contingent of mages headquartered at the University.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body83$),
('trades-and-vocations', 'Trades and Vocations', 'Getting Started', $body84$Although the average adventurer might say that they seek their fortune, it is more often glory that moves them to face terrible perils, stand up against monsters, and uncover lost mysteries. This is convenient, as adventuring can be a costly endeavour, and most monsters seem to leave their coin purses at home. More than one aspiring adventurer has learned that to pursue their passion, they must first undertake a far more dangerous quest. Getting a day job.
...
Within the Lakes Region, coins can be traded nearly at parity no matter what nation minted them, as the [[Near Lands|continental trade agreement]] substantially standardized the size of coins and their comparative value among nations signatory to the agreement. Coins minted before that date, or which were minted in adversarial or sufficiently distant nations may have different values, often calculated relative to the dross weight of the precious metals from which they were coined, or in some rare cases, their value to collectors.

## Art Pieces

While most pieces of fine art, including painting, tapestry, sculpture, and similar have a defined value, some art may have additional value to individual purchasers. Certainly, it takes longer to find these people – but historical or political importance is often associated with objets d’art, and recognizable pieces may have a history of their own, owing to their provenance or the reputation of the artist that created them.

While many merchants are undoubtedly able to move pieces of art through their existing connections, finding the hidden value of some pieces may be difficult, and may only be accomplished through the plying of connections and keeping an attentive ear to the ground.
...
Some rare creatures can also be sources for [[Components]], although collecting such components will often require specialized skills or tools to extract these components in such a way that the magic remains intact and useful.
...
Revised by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body86$),
('welcome-to-the-world-of-fantasy-alive', 'Welcome to the World of Fantasy Alive!', 'Getting Started', $body87$Welcome adventurer!

Fantasy Alive is set on the continent of Ariel, with two games set within the Lakes Region. The region is dotted with ruins dating back to the fallen Golden Age of Magic, containing monsters, traps, exquisite treasures, and lost magics, as, over the centuries, kingdoms have risen and fallen, leaving behind the wonders that they created, and the horrors that they were unable to destroy.
...
Wherever you may choose to make your mark, the time is ripe to do so now. Go forth, bold adventurer! Uncover ancient mysteries, seek out caches of lost wealth, stand fast against evil – or fall to it! Write your name among the stars – and [start your journey](https://fantasyalivelrp.com/event-schedule/) into the world of Fantasy Alive!
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body87$),
('written-languages-of-ariel', 'Written Languages of Ariel', 'Culture & Society', $body88$We had lost dozens to the seemingly nonsensical twists and turns of the labyrinth, crowded with traps and lousy with opportunistic monsters. It was only after several days that our scholar awoke from the sleeping poison and was able to identify the seemingly nonsensical writings on the wall as an obscure form of Elvish… granting useful directions.
...
Authored by: Andrew Dunlop Fantasy Alive Lore Team 2026 Copyright © Endless Adventures Ontario$body88$),
('yorik', 'Yorik', 'Towns & Settlements', $body89$Village of Yorik
...
- Duke Jagari of Gelrichwas revealed to be a worshipper of Stasa, goddess of undeath, and the underlying cause of the Michian War in service to his deity.
