...
City Total Population: About 8600 permanent residents, 76% of whom are [[Humans]], 8% dwarves, 6% [[Elves]], and 10% representative of the other sapient [[Peoples of the Lakes Region]].
...
Your character may have been a soldier, a mercenary, or a student of martial prowess, and studied weapon skills. Perhaps they have sought schooling as a wizard, or taken holy orders as a priest, or generally received an education in one of the [[Magic in the World of Fantasy Alive]] that are studied in the world of Ariel. Certainly, many new adventurers have previously plied [[Trades and Vocations]], seeking to earn a living. All of these skills can be useful in the course of play and between games, and you can use your starting build to reflect what your character has studied prior to their entry into the world of swords and sorcery!
...
Ensuring that you have the right equipment to succeed in your adventures can be challenging. In terms of coin, adventure tends to cost money more than it makes money. What treasure can be recovered often takes the form of equipment, or less immediately fungible [[Treasure and Valuables]], like jewels, rings, or elaborate vases and tapestries.
...
Curtainborns have no kingdom, nation, or empire of their own. They are found in many places across [[Kingdom of Harodom]] and beyond, and may be born to non-Curtainborn parents of any race.

### Playing a Curtainborn

Regardless of a Curtainborn’s origin, one thing is indisputable: they are intrinsically connected to the [[The Pantheon]]. Whether naturally drawn to the worship of their divine lineage, or nurtured and reared in a church chosen by others, it is incredibly rare for a Curtainborn to not be devoted to a god, even if most of their energy is focused on other pursuits. They have no real overarching cultural practices, adopting much of the culture of their mortal parents. The unifying features of the race are their divine connection and their outsider status among their birth cultures, leading many to feel the need to stick together. They often refer to each other as cousins, even when divine allegiances would suggest more conflict.
...
Goblins are, of course, famously incapable of using arcane magic – with a heavy ‘but’ at the end. Goblins can and do use [[Clerics and the Gods]], and many is the goblin diviner who has mystified even other seers, with strange auguries and insight into the hidden ways of the world. Too, there is nothing stopping goblins from using scrolls or potions, and many make use of these tools, either created by clerics, or purchased (or otherwise acquired) from those people who have fewer restrictions on their magical expression.
...
Barring proximity to a holy site, or being an entirely faith-based settlement, a small hamlet might have one, or perhaps two invested clerics [[Faith in the Lakes Region]], with perhaps an acolyte learning the ways of faith. While exceptions certainly exist, it is difficult to sustain too many full-time clergy within a limited area, although there may be several lay-followers of any number of religions, marking personal observances to the best of their abilities. Most often, the most dominant faith will pertain to the nature of the settlement – fishing villages will often have shrines to [[Beldon]] for example, and farming, forestry, and mining all receive some measure of blessing from [[Atha]].
...
The War of the Twins is thought to have begun in 1502 A.T., when two [[Elves]] twins identifying themselves as Sarna and Tivolous made known that they had raised armies of [[Undead]] and of [[Celestials and Infernals]]. Using these forces, and their own powerful magics, the Twins quickly assailed the nation of Deepwood, starting with the great city of Darkwood, likely in an effort to stem opposition from the powerful contingent of mages headquartered at the University.
