...
create policy "Members read item catalog" on item_availability for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on item_category;
create policy "Members read item catalog" on item_category for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on items;
create policy "Members read item catalog" on items for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on recipes;
create policy "Members read item catalog" on recipes for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on recipe_materials;
create policy "Members read item catalog" on recipe_materials for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on recipe_requirements;
create policy "Members read item catalog" on recipe_requirements for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on recipe_skill_requirements;
create policy "Members read item catalog" on recipe_skill_requirements for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on merchant_price_tiers;
create policy "Members read item catalog" on merchant_price_tiers for select using ((select auth.uid()) is not null);
drop policy if exists "Members read item catalog" on merchant_rarity_tiers;
create policy "Members read item catalog" on merchant_rarity_tiers for select using ((select auth.uid()) is not null);
